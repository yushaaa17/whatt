 ...
 if (teks == 'edukasi') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `📛)ഒ Info Bot`, rowId: ".botinfo", description: "✧ Info nya YushaBotz17 ><"},
	...
	{title: `⚡)ഒ Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 YushaBotz17..."},
	]
    },{
	...
	rows: [
	    ...
	    {title: `💰 ∫ » Donasi «`, rowId: ".payment", description: '✧ Support BOT agar on setiap hari non stop'},
	...
	{title: `⫹💌 › 𐐪-〚 Store 〛-𐑂`, rowId: ".? store", description: "╰► Fitur untuk jualan"},
	...
	rows: [
	  ...
	  {title: `🛒 ∫ » Website «`, rowId: ".groupbot", description: '✧ Jangan lupa mampir ya...'},
      ]
    },
]
...
const listMessage = {
  text: tek,
  footer: '© YUSHABOTZ17 | ALL RESERVED',
...
//-------DOC TEMPLATE
    const message = {
            ...
            pageCount: fpagedoc,
            caption: text,
            footer: titlebot + '\n⚡ Supported By YF-TEAM',
            templateButtons: [
                {
                    urlButton: {
                        displayText: `${namebot}`,
                        url: 'https://chat.whatsapp.com/C2LO1hC0R0bIVsLWrYuiZH'
                    }
                },
                {
                    urlButton: {

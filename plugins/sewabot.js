...
const sections = [
   {
	title: `${htjava} SEWA ✦-------`,
	rows: [
	    {title: "🔖 HEMAT", rowId: '.order *Paket:* 8K • Sewa', description: 'PRICE: ' + sh + 'k (15 Hari)' },
	    {title: "🔖 NORMAL", rowId: '.order *Paket:* 15K • Sewa', description: 'PRICE: ' + sn + 'k (1 bulan)' },
	{title: "🔖 Permanen", rowId: '.order *Paket:* 120K • Sewa', description: 'PRICE: ' + sv + 'k (Permanen)' },
	]
    }, {
	...
	{title: "🌟 PERMANENT", rowId: '.order *Paket:* 45K • Premium', description: 'PRICE: ' + ppm + 'k (UNLIMITED)' },
	]
    }, {
